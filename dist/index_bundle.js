...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConfirmBattleContainer = __webpack_require__(223);
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'button',
	          { type: 'submit', className: 'btn btn-lg btn-success' },
	          'Get Started'
	        )
	      )
	    );
	    ...
	    React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Github Username', value: props.username, onChange: props.onUpdateUser })
	        ),
	        React.createElement(
	          'div',
	          ...
	          React.createElement(
	            'button',
	            { className: 'btn btn-block btn-success', type: 'sumbit' },
	            'Continue'
	          )
	        )
	      )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var ConfirmBattle = __webpack_require__(224);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function ConfirmBattle(props) {
	  ...
	  // </div>
	  // <div className='col-sm-8 col-sm-offset-2'>
	  // <div className='col-sm-12' style={styles.space}>Initiate Battle</div>
	  // <div className='col-sm-12' style={styles.space}>Link to /playerOne</div>
	  // </div>
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var id = 'a75a7066a62ebaa5deba';
	var sec = 'af56c558772330a2f6852080d3c35512e479ed5b';
